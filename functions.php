<?php
/**
 * garbage-geek functions and definitions
 *
...
if ( ! function_exists( 'garbage_geek_setup' ) ) :
	/**
	 ...
	 */
	function garbage_geek_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on garbage-geek, use a find and replace
		 * to change 'garbage-geek' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'garbage-geek', get_template_directory() . '/languages' );
		...
		add_theme_support( 'custom-background', apply_filters( 'garbage_geek_custom_background_args', array(
...
add_action( 'after_setup_theme', 'garbage_geek_setup' );
 ...
 */
function garbage_geek_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'garbage_geek_content_width', 640 );
}
add_action( 'after_setup_theme', 'garbage_geek_content_width', 0 );
 ...
 */
function garbage_geek_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'garbage-geek' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'garbage-geek' ),
...
add_action( 'widgets_init', 'garbage_geek_widgets_init' );
...
function garbage_geek_scripts() {
	...
	if(is_front_page()){
		...
		//Chart Js
		wp_enqueue_script('chart-js-scripts', 'https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.7.3/Chart.min.js', null, '2.7.3');
	};
